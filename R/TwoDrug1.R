...
TwoDrug_identify_design<- function (location1, location2, location3, c0, r) {
  ...
  TwoDrug<-function (location1,location2) {
  ...
  TwoDrug<-TwoDrug(location1,location2)
...
SYN.design <- function(Drug1=Drug1, Drug2=Drug2, h=c(20,80), c0, r, method = "loglog", location3)
{
  # Input:
...
Drug1=Drug1, Drug2=Drug2, h=c(20,80), c0=c0, r=r, method = "loglog", location3=location3)
